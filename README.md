...
For ESP32 it requires [AsyncTCP](https://github.com/me-no-dev/AsyncTCP) to 
To use this library you might need to have the latest git version of [ESP32](https://github.com/espressif/arduino-esp32) Arduino Core
